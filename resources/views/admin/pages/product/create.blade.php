            ...
            <form role="form" action="{{ route('admin.product.store') }}" method="post">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <textarea name="technology" id="technology" class="form-control">{{ old('technology') }}</textarea>
                  </div>
                </div>
                {{--Presentation--}}
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <textarea name="presentation" id="presentation" class="form-control">{{ old('presentation') }}</textarea>
                  </div>
                </div>
                {{--Active--}}
                <div class="form-group row">
